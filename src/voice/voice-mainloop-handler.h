...
enum {
    ...
    VOICE_MAINLOOP_HANDLER_BUFFERS_ALTERNATIVE,
    VOICE_MAINLOOP_HANDLER_BUFFERS_PRIMARY,
    VOICE_MAINLOOP_HANDLER_CMT_UL_STATE_CHANGE,
    VOICE_MAINLOOP_HANDLER_CMT_DL_STATE_CHANGE,
    VOICE_MAINLOOP_HANDLER_TEMPERATURE_START,
